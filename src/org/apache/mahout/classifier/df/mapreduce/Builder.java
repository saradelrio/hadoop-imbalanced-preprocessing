...
public abstract class Builder {
  ...
  protected Builder(Path dataPath, Path datasetPath, Long seed, Configuration conf) {
  ...
  protected void setTreeBuilder(TreeBuilder treeBuilder) {
	  this.treeBuilder = treeBuilder;
  }
  ...
  public DecisionForest build(int nbTrees, Integer m)
    ...
    Job job = new Job(conf, "decision forest builder"+" (data:"+dataPath+" - ntrees:"+nbTrees+" - features:"+m+")");
